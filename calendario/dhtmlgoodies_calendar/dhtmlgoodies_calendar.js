...
function closeCalendar(){
	...
	//que hacer al cerrar el calendario
	//muestra(8);
...
function pickDate(e,inputDay)
{
	...
	// al cerrar el calendario por dia
	closeCalendar();
